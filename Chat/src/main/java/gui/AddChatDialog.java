...
public class AddChatDialog extends javax.swing.JDialog {
     ...
     */
    public AddChatDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ADD a new CHAT");
        ...
        jRadioButton1.setText("<html>\nJoin as anonimous<br> (by joining as anonimous your name will be hidden<br> and your session won't be saved when you leave the chat)\n</html>");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                AddChatDialog dialog = new AddChatDialog(new javax.swing.JFrame(), true);
